...
\usepackage{subcaption} % for subcaption, duh
...
\input{chapters/master-theorem}

\chapter{Operazioni fra matrici}
\input{chapters/operazioni-matrici}

\chapter{Trasformata veloce di \textit{Fourier}}
\input{chapters/trasformata-fourier}

\chapter{Programmazione dinamica}
\input{chapters/programmazione-dinamica}

\chapter{Paradigma \emph{Greedy}}
\input{chapters/paradigma-greedy}
